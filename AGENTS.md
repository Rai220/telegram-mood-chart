...
- **Дедупликация**: если одно и то же сообщение (date_unix + text[:200]) встречается в нескольких источниках, оставить одну копию. Приоритет: свежий JSON > старый JSON > Google Chat > HTML > QIP.
